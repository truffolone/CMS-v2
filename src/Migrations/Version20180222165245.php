 ...
 */
class Version20180222165245 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE contracts ADD client_id INT NOT NULL');
        $this->addSql('ALTER TABLE contracts ADD CONSTRAINT FK_950A97319EB6921 FOREIGN KEY (client_id) REFERENCES clients (id)');
        $this->addSql('CREATE INDEX IDX_950A97319EB6921 ON contracts (client_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE contracts DROP FOREIGN KEY FK_950A97319EB6921');
        $this->addSql('DROP INDEX IDX_950A97319EB6921 ON contracts');
        $this->addSql('ALTER TABLE contracts DROP client_id');
